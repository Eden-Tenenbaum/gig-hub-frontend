...
function unitTestReducer() {
    ...
    const gig1 = { _id: 'b101', title: 'Gig ' + parseInt('' + Math.random() * 10), price: 12, owner: null, msgs: [] }
    const gig2 = { _id: 'b102', title: 'Gig ' + parseInt('' + Math.random() * 10), price: 13, owner: null, msgs: [] }
    ...
    state = gigReducer(state, { type: SET_GIG, gig: gig1 })
    console.log('After SET_GIG:', state)
