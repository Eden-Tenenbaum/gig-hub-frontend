...
export const StarIcon = _svgBuilder(
...
export const HeartIcon = _svgBuilder(
...
export const ClockIcon = _svgBuilder(
    <>
...
export const LoopIcon = _svgBuilder(
    <>
...
export const CheckmarkIcon = _svgBuilder(
    ...
    { fill: '#dadbdd', viewBox: '0 0 11 9' }
)

function _svgBuilder(paths, options = {}) {
    const { width = 16, height = 16, viewBox = '0 0 16 16', fill = '', className = 'icon', ...defaultProps } = options

    return function svgCmp(props) {
        return (
